...
\subsubsection{\textbackslash drawPointL[verticalAlignment][LinesToOmit]\{PointName\}}\label{drawPointL}
	...
	Draws a point, depicted as line segments starting/ending in it \drawPointL{A}.
...
\subsubsection{\textbackslash drawPoint[verticalAlignment][LinesToOmit]\{PointName\}}
	...
	Draws a point, depicted as line segments starting/ending in it with a point mark if defined \drawPoint{A}.

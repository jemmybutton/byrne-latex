...
\subsubsection{byNamedLineSeq(lineShift)(LINES\_LIST)}\label{byNamedLineSeq}
	...
	\defineNewPicture[1]{
		...
		draw byNamedLineSeq(0)(AB,BC) scaled 2;
	}
	...
	draw byNamedLineSeq(1)(AB,BC) scaled 2;
...
This angle style employs two optional colors and can be called by setting \texttt{style} argument \ref{byAngleDefine} to \texttt{3}. This is what the result of \texttt{byAngleDefineExtended(A, B, C, byred, 3)(byblue, byyellow);} looks like:\drawAngle{B} \ref{byAngleDefineExtended}.
